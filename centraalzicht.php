  ...
  <main>
    ...
    <section class="experience">
      <div class="experience-text">
        ...
        <p>
          Deze ervaring is heel simpel, probeer het <strong> Rode Shirt</strong>te zoeken en te kopen, het enige wat je hindert in je zoektocht is het vervagen/verlies van je centrale zicht.
