...
<body>
  ...
  <main>
    ...
    <section class="product-grid">
      ...
      <div class="product" data-product="choochoo">
        ...
        <p>€21,99</p>
        <button class="bestel-btn">Bestel</button>
      </div>

      <div class="product" data-product="soad">
      ...
      <div class="product" data-product="nirvana">
      ...
      <div class="product" data-product="rammstein">
      ...
      <div class="product" data-product="motorhead">
      ...
      <div class="product" data-product="slipknot">
      ...
      <div class="product" data-product="korn">
        <img src="images/producten/korn.webp" alt="Korn shirt" />
        <h3>"New Doll" T-shirt zwart van Korn </h3>
        <p>€23,75</p>
        <button class="bestel-btn">Bestel</button>
      </div>

      <div class="product" data-product="wbtbwb">
      ...
      <div class="product" data-product="brojob1">
      ...
      <div class="product" data-product="brojob2">
      ...
      <div class="product" data-product="ac">
      ...
      <div class="product" data-product="zombie">
      ...
      <div class="product" data-product="heaven">
        <img src="images/producten/wrong_side_of_heaven_ffdp.jpg" alt="Wrong Side Of Heaven shirt" />
        <h3>"Five Finger Death Punch 'Wrong Side Of Heaven' T-Shirt"</h3>
        <p>€22,50</p>
        <button class="bestel-btn">Bestel</button>
      </div>

      <div class="product" data-product="aa">
      ...
      <div class="product" data-product="flogging">
        <img src="images/producten/T-shirts-Flogging-Molly-Flogging-Molly-T-shirt-Vintage.jpg" alt="Flogging Molly shirt" />
        <h3>"Flogging Molly T-shirt Vintage Irish Punk"</h3>
        <p>€22,50</p>
        <button class="bestel-btn">Bestel</button>
      </div>

      <div class="product" data-product="unicorn">
  ...
  <div id="completionScreen" style="display: none; text-align: center;">
    ...
    <a href="centraalzicht.php" id="restartBtn" class="button-link">Terug naar Verlies van Centraal Zicht</a>
  </div>

  <script src="js/centraalzichtervaring.js"></script>
</body>
</html>
